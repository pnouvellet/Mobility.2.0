...
opts_chunk$set(fig.path='../../../../Box Sync/save_research/Mobility.2.0.Save/Saved_file/FitModels/R0_beta_tD_Over/figs/', fig.keep='high', 
...
for (date_num in 1:length(dates_input)){
  ...
  for (Mdata in c('A','G')){
    ...
    #   si=2
      ...
      b <- 0
      o <- 1
      t_change <- which(as.character(D$dates) %in% c('2020-04-15'))
      ...
      prior_theta <- matrix(c(rep(c(0,5),N_geo),
                              ...
                              rep(c(0,5),N_geo),
                              rep(c(-1e2,1e2),N_geo),
                              rep(c(t_change-7*2,nrow(D)-7*2),N_geo), # t_change
 ...
 #################################### 
    ...
    saveRDS(object = output,
            file = paste0('../../../../Box Sync/save_research/Mobility.2.0.Save/Saved_file/FitModels/R0_beta_tD_Over/Rdata/',
