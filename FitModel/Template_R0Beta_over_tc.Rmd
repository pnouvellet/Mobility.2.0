...
opts_chunk$set(fig.path='../../Mobility.2.0.Save/Saved_file/FitModels/R0_beta_tD_Over/figs/', fig.keep='high', 
...
for (date_num in 1:length(dates_input)){
 ...
 #################################### 
    ...
    saveRDS(object = output,
            file = paste0('../../Mobility.2.0.Save/Saved_file/FitModels/R0_beta_tD_Over/Rdata/',
