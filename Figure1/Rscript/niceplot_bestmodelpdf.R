niceplot <- function(i,res_summary, res_base,inputs){
  ...
  fig.name=paste0('../../../../Dropbox (SPH Imperial College)/Mobility.2.0.Save/Saved_file/figure1/fig_BestModels/',Mdata,'/',country[i],'.pdf')
  pdf(file = fig.name, width = 9, height=6)
