...
for(i in 2:ncol(d)){
  ...
  if(c==1){
    ...
    # combined ones 
      lines(d$dates,M_process$Combined$Apple_c[,i], col='grey50',lwd=2)
      lines(d$dates,M_process$Combined$AG[,i], col='grey0',lwd=2)
  }
  ...
  if(c==1){
    ...
    # combined ones 
      lines(d$dates,M_process$Combined$Google_c[,i], col='grey50',lwd=2)
      lines(d$dates,M_process$Combined$AG[,i], col= 'grey0',lwd=2)
  }
  ...
  if(n_colf == 2){
    ...
    legend('topleft',legend = c('A or G','C'),
           col = c('grey50','grey0') ,bty='n',lwd=1, seg.len = 1)
  }
}
