...
eliminate coiuntry with high within week variation
...
rm(i,keep,temp,x,col_n,rollD,obs,temp,elim,f)
...
i=1
temp <- ( dM$apple[which(dM$apple$transportation_type == stream_apple[i]),-c(1,3)] )
