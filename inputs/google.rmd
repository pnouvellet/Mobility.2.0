...
d_m <- read.csv(file=paste0(path_s,'inputs/applemobilitytrends-2020-09-12.csv'),
...
# trim datasets
d_g <- d_g[,1:which(names(d_g) %in% 'X2020.09.06')]
d_m <- d_m[,1:which(names(d_m) %in% 'X2020.09.06')]
tail(names(d_g))
tail(names(d_m))
