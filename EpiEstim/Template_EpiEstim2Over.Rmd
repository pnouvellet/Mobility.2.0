...
opts_chunk$set(fig.path='../../../../Box Sync/save_research/Mobility.2.0.Save/Saved_file/EpiEstim/figs/', fig.keep='high', 
...
for (date_num in 1:length(dates_input)){
  ...
  for (Mdata in c('A','G')){
    ...
    saveRDS(object = output,
            file = paste0('../../../../Box Sync/save_research/Mobility.2.0.Save/Saved_file/EpiEstim/Rdata/',
